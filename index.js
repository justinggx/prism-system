...
function injectPrismSettingsSwitchStyles() {
    if (document.getElementById('prism-settings-switch-style')) return;
    const style = document.createElement('style');
    style.id = 'prism-settings-switch-style';
    style.textContent = `
        #prism-settings .prism-status-line{display:flex!important;align-items:center!important;justify-content:space-between!important;gap:12px!important}
        #prism-settings .prism-status-switch{position:relative!important;display:inline-block!important;width:44px!important;height:24px!important;flex:0 0 44px!important;margin-left:auto!important;cursor:pointer!important}
        #prism-settings .prism-status-switch input{opacity:0!important;width:0!important;height:0!important;position:absolute!important}
        #prism-settings .prism-status-switch span{position:absolute!important;inset:0!important;border-radius:999px!important;background:rgba(90,78,110,.75)!important;border:1px solid rgba(255,255,255,.14)!important;transition:.22s!important;box-shadow:inset 0 0 8px rgba(0,0,0,.35)!important}
        #prism-settings .prism-status-switch span:before{content:''!important;position:absolute!important;width:18px!important;height:18px!important;left:2px!important;top:2px!important;border-radius:50%!important;background:#f7f1ff!important;transition:.22s!important;box-shadow:0 2px 8px rgba(0,0,0,.45)!important}
        #prism-settings .prism-status-switch input:checked+span{background:linear-gradient(135deg,#7c3aed,#a855f7)!important;border-color:rgba(216,190,255,.45)!important}
        #prism-settings .prism-status-switch input:checked+span:before{transform:translateX(20px)!important}
    `;
    ...
    <div id="prism-settings">
        <div class="inline-drawer">
            ...
            <div class="inline-drawer-content">
                <div class="prism-toggle-row" style="display:flex;align-items:center;justify-content:space-between;gap:12px;margin-bottom:10px;padding:8px 12px;background:rgba(17,10,26,.7);border:1px solid rgba(255,255,255,.08);border-radius:6px;">
                    <span style="font-size:13px;color:#e0d6f0;font-weight:500;">启用 Prism 监管系统</span>
                    <label class="prism-switch" style="position:relative;display:inline-block;width:42px;height:22px;flex-shrink:0;">
                        <input id="prism-enabled-toggle" type="checkbox" ${checked} style="opacity:0;width:0;height:0;position:absolute;" />
                        <span class="prism-switch-slider" style="position:absolute;cursor:pointer;inset:0;background:rgba(80,60,100,.5);border-radius:22px;transition:background .25s;"></span>
                    </label>
                </div>
...
jQuery(async () => {
    ...
    injectPrismSettingsSwitchStyles();
